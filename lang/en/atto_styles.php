...
$string['config_desc'] = 'Configuration for the styles widget for Atto in JSON format. <br /> You can find an extensive example in the README.md in the section <a href="https://github.com/moodle-an-hochschulen/moodle-atto_styles/blob/main/README.md#usage--settings">"Usage & Settings"</a>.
<hr />
For example:<br />
{$a->code_example}
<hr />
